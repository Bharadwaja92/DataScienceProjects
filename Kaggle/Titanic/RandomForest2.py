...
parameters = {'n_estimators': (21, 22, 23),
              'min_samples_split': (5, 10, 15, 20, 25, 30),
              'min_samples_leaf': (2, 3, 4, 5, 6)}

rfc = RandomForestClassifier()

clf = GridSearchCV(rfc, parameters, verbose=2)
...
#     })
#
# mySubmission.to_csv('/home/saibharadwaj/Downloads/Ast/DSP/Titanic/all/MySubmission2.csv', index=False)
